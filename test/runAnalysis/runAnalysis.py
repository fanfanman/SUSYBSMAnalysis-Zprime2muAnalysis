...
config = config()
config.General.requestName = 'dileptonAna_%s_2017smearReal'
...
config.Data.outputDatasetTag = 'dileptonAna_%s_2017smearReal'
config.Data.outLFNDirBase = '/store/user/zhangfa/DYMC2017smearReal'
