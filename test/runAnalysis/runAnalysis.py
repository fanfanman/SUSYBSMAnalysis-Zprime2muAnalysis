...
config = config()
config.General.requestName = 'dileptonAna_%s_2018ebeCorrect'
...
config.Data.outputDatasetTag = 'dileptonAna_%s_2018ebeCorrect'
config.Data.outLFNDirBase = '/store/user/zhangfa/DYMC2018ebeCorrect'
